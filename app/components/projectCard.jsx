...
const ProjectCard = ({ image, title, company, description, technologies, link }) => {
  return (
    <div className="relative bg-transparent shadow-lg rounded-lg overflow-hidden mx-auto transition duration-300 flex flex-col sm:flex-row items-start m-10 p-2">
